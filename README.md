...
>
> ├── **Modal_GPU_ez** — HuggingFace 모델을 Modal GPU에 원클릭 배포하는 연결 모듈 &nbsp; `pip install modal-gpu-ez` → `import modal_gpu_ez as mg`
> <br/>
> <a href="https://github.com/AlgoceanApiLib/Modal_GPU_ez"><img src="https://img.shields.io/badge/GitHub-Modal__GPU__ez-181717?style=flat-square&logo=github"/></a> <a href="https://pypi.org/project/modal-gpu-ez/"><img src="https://img.shields.io/badge/PyPI-modal--gpu--ez-3775A9?style=flat-square&logo=pypi&logoColor=white"/></a>
>
> └── **Langchain-modal-gpu-ez** — LangChain 전용 Modal GPU 연결 모듈 &nbsp; `pip install langchain-modal-gpu-ez` → `from langchain_modal_gpu_ez import ModalGpuEzLLM`
> <br/>
> <a href="https://github.com/AlgoceanApiLib/Langchain-modal-gpu-ez"><img src="https://img.shields.io/badge/GitHub-Langchain--modal--gpu--ez-181717?style=flat-square&logo=github"/></a> <a href="https://pypi.org/project/langchain-modal-gpu-ez/"><img src="https://img.shields.io/badge/PyPI-langchain--modal--gpu--ez-3775A9?style=flat-square&logo=pypi&logoColor=white"/></a>
...
<a href="https://github.com/GeulteoProject/BE">
